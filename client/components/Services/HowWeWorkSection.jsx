    ...
    () => [
      {
        title: "Strategy",
        icon: "map",
        description: "We clarify your goals, offer, funnel, and success metrics."
      },
      {
        title: "Execution",
        icon: "construction",
        description: "We ship campaigns, content, and pages with speed and precision."
      },
      {
        title: "Optimization",
        icon: "tune",
        description: "We test, track, and improve conversion and efficiency weekly."
      },
      {
        title: "Scaling",
        icon: "trending_up",
        description: "We double down on what works and expand across channels."
      }
    ],
    []
  );
          ...
          >
            <div className="max-w-2xl">
              ...
              <p className="mt-3 text-body text-textSecondary">
                A simple, repeatable process that keeps execution fast and results measurable.
              </p>
            </div>
